!(function(global) {
  ...
  CityCommand.prototype.handleUI = function() {
    ...
    // 通过信息获取太守名称
    var satrapName = data[this.period + 'HerosName'][parseInt(cityInfo[2]) - 1];
    if (satrapName) {
      this.ui.lordHead.graphics.drawTexture(util.getHeadImage(this.period, satrapName), 0, 0, 80, 80);
    } else {
      satrapName = '无';
    }
    // 给头像加阴影效果
    ...
    this.ui.mgrName.text = satrapName;
    ...
    this.ui.searchBtn.on(Event.CLICK, this, this.openHeroList);
  }
